...
from beam_abm.decision_function.io import parse_list_arg, slugify
from beam_abm.decision_function.missingness import DEFAULT_MISSINGNESS_THRESHOLD
from beam_abm.decision_function.plan_io import extract_predictors_from_model_plan
...
def run_anchor_prototype_build_workflow(
    *,
...
def run_anchor_prototype_diagnostics_workflow(
    *,
    input_csv: Path = CSV_FILE_CLEAN,
...
def run_anchor_prototype_reference_effects_workflow(
    *,
    input_csv: Path = CSV_FILE_CLEAN,
    anchors_dir: Path = Path("empirical/output/anchors/system"),
...
def run_anchor_prototype_reference_effects_full_workflow(
    *,
    input_csv: Path = CSV_FILE_CLEAN,
    anchors_dir: Path = Path("empirical/output/anchors/system"),
    outdir: Path,
