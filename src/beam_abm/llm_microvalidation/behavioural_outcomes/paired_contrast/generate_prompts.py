...
from beam_abm.decision_function.io import parse_list_arg
...
def run_cli(argv: list[str] | None = None) -> None:
    ...
    if task_args.mv_task == "belief_update":
        from beam_abm.llm_microvalidation.psychological_profiles.prompt_generation import generate_belief_prompts
