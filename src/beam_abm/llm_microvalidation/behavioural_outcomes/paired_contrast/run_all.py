...
from beam_abm.llm_microvalidation.utils.alignment_utils import (
...
def run_cli(argv: list[str] | None = None) -> None:
    ...
    from beam_abm.llm_microvalidation.shared.apply_calibration_to_ice import run_cli as apply_calibration_step
    from beam_abm.llm_microvalidation.shared.apply_pe_calibration_to_ice import run_cli as apply_pe_calibration_step
    from beam_abm.llm_microvalidation.shared.calibrate_llm_predictions import run_cli as calibrate_step
    from beam_abm.llm_microvalidation.shared.calibrate_pe_gains import run_cli as pe_calibrate_step
