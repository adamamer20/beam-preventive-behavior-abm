...
from beam_abm.llm_microvalidation.behavioural_outcomes.posthoc import (
    compute_slice_spearman,
    compute_y_decile_errors_from_df,
    summarize_choice_validation_posthoc_metrics,
)
from beam_abm.llm_microvalidation.shared.calibration import fit_binary_platt_country, fit_isotonic_country
...
def _extract_row_id(dataset_id: object) -> int | None:
    ...
    from beam_abm.llm_microvalidation.behavioural_outcomes._canonicalize_ids import normalize_choice_dataset_id
...
def compute_reference_benchmark(
    *,
    ...
    from beam_abm.decision_function.io import load_column_types_with_reference
    from beam_abm.decision_function.missingness import apply_missingness_plan_pd, build_missingness_plan_pd
    from beam_abm.decision_function.modeling import ModelBlock, ModelSpec, _prepare_formula, standardize_columns
