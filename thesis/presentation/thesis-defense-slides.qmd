...
## Thesis proposal: from empirical backbone to simulation and validation {.pipeline-slide}
...
```{=html}
  ...
  <div class="pipeline-fork-svg" aria-hidden="true">
    <svg viewBox="0 0 180 240" preserveAspectRatio="none">
      <path d="M 0 120 L 72 120" />
      <path class="fragment fade-up" data-fragment-index="1" d="M 72 120 L 72 40 L 180 40" />
      <path class="fragment fade-up" data-fragment-index="2" d="M 72 120 L 72 200 L 180 200" />
    </svg>
  </div>

  <div class="pipeline-branches">
    <div class="pipeline-card pipeline-card-mid fragment fade-up" data-fragment-index="1">
    ...
    <div class="pipeline-card pipeline-card-light fragment fade-up" data-fragment-index="2">
...
::: {.takeaway .takeaway-final .fragment .fade-up data-fragment-index="1"}
...
::: {.takeaway .takeaway-final .fragment .fade-up data-fragment-index="2"}
...
```{=html}
  ...
  <div class="takeaways-conclusion-box fragment fade-up" data-fragment-index="3">
```
...
## Construct dictionary {.smaller visibility="hidden"}
