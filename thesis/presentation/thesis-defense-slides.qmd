...
::: {.abm-slide-subtitle}
The same cumulative result can come from very different time paths.
:::
...
::: {.abm-side-takeaways .abm-dynamics-takeaways}
::: {.abm-takeaway}
**Norm campaign:** gradual build-up, long tail.
:::

::: {.abm-takeaway}
**Outbreak wave:** sharp rise, then relaxation.
:::

::: {.abm-takeaway}
**Trust erosion:** persistence mainly in vaccination.
:::
:::
