...
<div class="pipeline-fork">
  ...
  <div class="pipeline-branches">
    <div class="pipeline-card pipeline-card-mid">
      <div class="pipeline-title">2a. LLM micro-validation</div>
    ...
    <div class="pipeline-card pipeline-card-light">
      <div class="pipeline-title">2b. Survey-grounded ABM</div>
...
<div class="evaluation-design-grid">
  ...
  <div class="evaluation-design-cards">
    ...
    <div class="evaluation-design-card">
      ...
      <div class="evaluation-design-item">psychological profile variables (e.g. trust, legitimacy, perceived stakes)</div>
    ...
    <div class="evaluation-design-card">
      ...
      <div class="evaluation-design-item">profiles: profile shape and variable-wise recovery</div>
      ...
      <div class="evaluation-design-item">profiles: which dimensions move, and spillover containment</div>
    </div>
  </div>
</div>
```
...
<div class="baseline-synthesis-subheadline">
  <ul class="baseline-synthesis-bullets">
    <li>Ranking is recovered more reliably than levels, but remains below the empirical reference.</li>
    <li>Profile shape is partly recovered, but profile variation remains compressed <span class="baseline-synthesis-inline-note">(median compression ratio: 0.41 vs 0.46 for behavioural outcomes).</span></li>
  </ul>
</div>
...
<div class="baseline-synthesis-grid">
  <div class="baseline-synthesis-table">
    ...
    <table class="baseline-synthesis-metrics">
      <thead>
        <tr>
          <th>Outcome</th>
          <th>LLM rank (Gini)</th>
          <th>LLM level (Skill)</th>
          <th>Reference rank (Gini)</th>
        </tr>
      </thead>
      <tbody>
        <tr>
    ...
    <div class="baseline-synthesis-footnote">Higher is better. Gini = rank recovery; Skill = level accuracy vs simple baseline.</div>
  </div>

  <div class="baseline-synthesis-side">
    <div class="baseline-synthesis-label">Psychological profiles</div>
    <img
    ...
    />
    <div class="baseline-synthesis-footnote">Cosine similarity: higher = better profile-shape recovery.</div>
  </div>
</div>
```
...
<div class="perturbed-results-top">
  <div class="perturbed-results-subtitle">
    Under controlled shifts, paired contrast improves perturbation ordering, but effect-size calibration and placebo containment remain weak.
  </div>
</div>
...
::: {.takeaway style="font-size: 1.02em; margin-bottom: 1.05em;"}
...
::: {.takeaway style="font-size: 1.02em; margin-bottom: 1.05em;"}
**3. A survey-grounded hybrid ABM is the more credible route**

An empirical backbone plus bounded dynamics gives more interpretable policy comparisons.
:::
...
## {.thank-you-slide background-color="#fafbfc"}

```{=html}
<div class="thank-you-slide-inner">
```

::: {style="color: #1e4f86; font-size: 1.45em; text-align: center; width: 100%; margin: 0;"}
Thank you
:::
