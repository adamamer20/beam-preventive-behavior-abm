...
<div class="abm-process-subtitle">
  Agents do not jump instantly to a new state: they move gradually toward a changing target.
</div>
...
<div class="abm-process-wrap">
  <div class="abm-process-grid">
    <div class="abm-process-box">
      ...
      <div class="abm-process-title">Survey-grounded starting point</div>
      <div class="abm-process-body">
        Each agent starts from a survey-based profile.
        Survey equations map profile into behaviour.
      </div>
    </div>

    <div class="abm-process-arrow" aria-hidden="true">→</div>

    <div class="abm-process-box abm-process-target">
      <div class="abm-process-step">2</div>
      <div class="abm-process-title">A changing target is computed</div>
      <div class="abm-process-body">
        <strong>Target for mutable constructs =</strong>
        model-implied baseline for that agent
      </div>
      <div class="abm-target-stack">
        <div>policy signals</div>
        <div>social exposure</div>
        <div>local epidemic conditions</div>
      </div>
    </div>
    ...
    <div class="abm-process-box">
      ...
      <div class="abm-process-title">Behaviour and feedback</div>
      <div class="abm-process-body">
        Behaviour is recomputed.
        More protection lowers local incidence.
        Local incidence shifts later risk signals.
      </div>
    </div>
  </div>

  <div class="abm-feedback-loop" aria-hidden="true">
    <svg class="abm-feedback-svg" viewBox="0 0 1000 84" preserveAspectRatio="none">
      <path d="M 880 10 C 740 76 390 76 260 10"></path>
    </svg>
    <div class="abm-feedback-head"></div>
  </div>
</div>
