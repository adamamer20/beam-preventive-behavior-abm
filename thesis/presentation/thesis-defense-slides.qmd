...
<div class="baseline-synthesis-table">
  ...
  <div class="baseline-synthesis-footnote">Higher is better. Gini = rank recovery; Skill = level accuracy relative to a simple baseline. Reference values come from the empirical statistical models.</div>
</div>
```
