...
def main(
    ...
    outdir: Path = typer.Option(DEFAULT_OUTDIR, "--outdir", help="Output directory for tables"),
    ...
    # Optional: summarize boolean groups if present
    ...
    try:
        ...
        logger.warning("Failed to compute boolean groups summary: {e}", e=str(e))
