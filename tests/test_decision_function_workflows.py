...
from beam_abm.decision_function.missingness import drop_nonfinite_rows_pl
from beam_abm.decision_function.workflows import anchor_prototypes as anchor_workflows
from beam_abm.decision_function.workflows import backbone_models as modeling_workflows
from beam_abm.decision_function.workflows.descriptive_statistics import run_descriptive_statistics_workflow
...
def test_modeling_workflow_orchestration(monkeypatch) -> None:
    ...
    modeling_workflows.run_backbone_models_fit_workflow(log_level="INFO")
    modeling_workflows.run_backbone_models_block_importance_workflow(log_level="INFO")
    modeling_workflows.run_backbone_models_workflow(log_level="INFO")
...
def test_anchor_workflow_orchestration(monkeypatch, tmp_path: Path) -> None:
    ...
    anchor_workflows.run_anchor_prototype_build_workflow(features="age,income")
    anchor_workflows.run_anchor_prototype_diagnostics_workflow()
    anchor_workflows.run_anchor_prototype_reference_effects_workflow(
        target_col="outcome", driver_cols="age", levers="age"
    )
    anchor_workflows.run_anchor_prototype_reference_effects_full_workflow(
...
def test_missingness_plan_polars_handles_string_numeric_median_fill() -> None:
    ...
    from beam_abm.decision_function.missingness import apply_missingness_plan_pl, build_missingness_plan_pl
